 ...
 * @author A199026
 */
@WebServlet(name = "EAPServlet", urlPatterns = {"/EAPServlet"})
public class EAPServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        String smartApp=request.getParameter("smartApp");
        String debit=request.getParameter("debit");
        
        response.setHeader("withdrawal",withdrawal);
        response.setHeader("inter",inter);
        response.setHeader("payments",payments);
        response.setHeader("smartApp",smartApp);
        response.setHeader("debit",debit);
        
        processRequest(request, response,"/EAP.jsp");
    }
